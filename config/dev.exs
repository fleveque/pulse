...
config :pulse, PulseWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "QCt0c2C3+T1pu5GIv3wRmHgal215Lk7W9PB+79fOwdnY56DZfz0IXXERHqZ1PSR1",
  watchers: [
...
# NATS connection (local dev)
config :pulse, :nats,
  host: "localhost",
  port: 4222

config :pulse, :nats_env_prefix, "dev"
